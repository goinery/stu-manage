...
INSERT INTO public.student VALUES ('s005', '2025005', '林云', '123456', '13712345001', 'linyun@qq.com', '3', '2', '2024-09-01 08:00:00', '1');
INSERT INTO public.student VALUES ('s006', '2025006', '苏毅', '123456', '13812345002', 'suyi@qq.com', '3', '2', '2024-09-01 08:00:00', '1');
INSERT INTO public.student VALUES ('s007', '2025007', '叶凡辰', '123456', '13612345003', 'yefc@qq.com', '3', '2', '2024-09-01 08:00:00', '1');
INSERT INTO public.student VALUES ('s008', '2025008', '陈浩', '123456', '15812345004', 'chenhao@qq.com', '3', '3', '2024-09-01 08:00:00', '1');
INSERT INTO public.student VALUES ('s009', '2025009', '吴峰', '123456', '18712345005', 'wufeng@qq.com', '3', '3', '2024-09-01 08:00:00', '1');
INSERT INTO public.student VALUES ('s010', '2025010', '张华', '123456', '13012345006', 'zhanghua@qq.com', '3', '3', '2024-09-01 08:00:00', '1');
...
-- 软件工程学院(1) · 当前学年 2025上半学年 —— 学生“推荐选课”来源
INSERT INTO public.course VALUES ('c01', '计算机网络', '1', '1', '6号主教学楼 301', '星期一 上午第一节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 4.0, '2025上半学年', '2025-07-10 00:00:00', 50, 5, 3, '本课程系统讲授计算机网络的基本原理和技术，包括OSI参考模型、TCP/IP协议族、局域网与广域网技术、网络安全基础等。要求学生掌握网络编程的基本方法。', '1');
INSERT INTO public.course VALUES ('c02', '操作系统原理', '1', '1', '6号主教学楼 302', '星期二 上午第二节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 4.0, '2025上半学年', '2025-07-10 00:00:00', 50, 4, 3, '本课程介绍操作系统的基本概念、原理和实现技术，包括进程管理、内存管理、文件系统、I/O系统等内容，结合Linux操作系统进行实践教学。', '1');
INSERT INTO public.course VALUES ('c03', '数据库系统原理', '1', '2', '6号主教学楼 303', '星期三 下午第一节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 3.5, '2025上半学年', '2025-07-10 00:00:00', 50, 3, 2, '本课程讲授关系数据库理论、SQL语言、数据库设计、事务处理、并发控制、数据库优化等内容。学生需要完成一个完整的数据库应用系统设计与开发。', '1');
...
INSERT INTO public.course VALUES ('c05', 'Java程序设计', '1', '1', '6号主教学楼 305', '星期五 上午第四节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 4.0, '2025上半学年', '2025-07-10 00:00:00', 50, 3, 2, '本课程系统讲授Java程序设计语言及面向对象编程方法，包括Java基础语法、面向对象特性、集合框架、多线程编程、网络编程等内容。', '1');
-- 软件工程学院(1) · 往期学年 —— 学生“方案内选课”来源
...
INSERT INTO public.course VALUES ('c07', '编译原理', '1', '2', '6号主教学楼 301', '星期二 下午第二节课 1-16周', '2024-09-01 00:00:00', '2024-09-05 00:00:00', 3.5, '2024下半学年', '2025-01-15 00:00:00', 45, 3, 1, '本课程讲授编译原理的基本理论和技术，包括词法分析、语法分析、语义分析、中间代码生成、代码优化和目标代码生成等内容。', '1');
INSERT INTO public.course VALUES ('c08', '计算机组成原理', '1', '1', '6号主教学楼 302', '星期三 上午第二节课 1-16周', '2024-03-01 00:00:00', '2024-03-05 00:00:00', 4.0, '2024上半学年', '2024-07-10 00:00:00', 50, 4, 1, '本课程讲授计算机硬件系统的基本组成和工作原理，包括数据表示与运算、CPU设计、存储系统、输入输出系统等内容。', '1');
-- 计算机科学与技术学院(2) · 当前学年 —— 软件工程学院学生的“方案外选课”来源
INSERT INTO public.course VALUES ('c09', '人工智能导论', '2', '3', '7号教学楼 202', '星期二 下午第三节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 3.0, '2025上半学年', '2025-07-10 00:00:00', 40, 3, 3, '本课程介绍人工智能的基本概念、方法与应用，包括搜索策略、知识表示、机器学习、深度学习、自然语言处理等内容。', '1');
INSERT INTO public.course VALUES ('c10', '算法设计与分析', '2', '4', '7号教学楼 201', '星期四 下午第一节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 3.0, '2025上半学年', '2025-07-10 00:00:00', 40, 3, 3, '本课程讲授算法设计与分析的基本方法，包括分治法、动态规划、贪心算法、回溯法、分支限界法等内容。', '1');
-- 数学学院(3) · 当前学年 —— 软件工程学院学生的“方案外选课”来源
INSERT INTO public.course VALUES ('c11', '高等数学A', '3', '5', '1号教学楼 101', '星期一 下午第三节课 1-18周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 5.0, '2025上半学年', '2025-07-15 00:00:00', 80, 5, 3, '本课程为理工科基础课程，讲授微积分、多元函数微分学、重积分、曲线曲面积分、无穷级数等内容。', '1');
INSERT INTO public.course VALUES ('c12', '线性代数', '3', '5', '1号教学楼 102', '星期三 上午第四节课 1-16周', '2025-03-01 00:00:00', '2025-03-08 00:00:00', 3.0, '2025上半学年', '2025-07-15 00:00:00', 70, 4, 2, '本课程讲授行列式、矩阵、向量空间、线性变换、特征值与特征向量、二次型等内容。', '1');

INSERT INTO public.selection_stage VALUES ('ss01', '2025上半学年', '第一阶段-推荐选课', 1, '2025-03-01 00:00:00', '2025-03-05 23:59:59', '1', '0', '0', '1');
INSERT INTO public.selection_stage VALUES ('ss02', '2025上半学年', '第二阶段-全面开放', 2, '2025-03-06 00:00:00', '2027-08-30 23:59:59', '1', '1', '1', '1');

-- 演示学生 s001(2025001/软件工程学院)——四个页面的核心数据
-- 当前学年在修课程(state=0)：首页/我的课程显示，覆盖 推荐4 + 方案外2
...
-- 往期已完成课程(state=1，已评定合格)：数据分析“已完成”及方案内统计
...
-- 其余软件工程学院学生(s002-s004)：填充推荐课程的已选人数
